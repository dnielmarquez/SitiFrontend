...
import { RequestRepairListTable } from 'src/sections/dashboard/company/request-repair-list-table';
const Page = () => {
      ...
      >
        <Container maxWidth="xl">
          ...
          <Stack spacing={4}>
            ...
            >
              <Stack spacing={1}>
                <Typography variant="h4">Orders to repair</Typography>
              </Stack>
            </Stack>
            <Card>
              <RequestRepairListTable requests={requests} />
            </Card>
          </Stack>
        </Container>
      </Box>
