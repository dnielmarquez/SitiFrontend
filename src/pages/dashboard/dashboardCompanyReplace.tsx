...
import { RequestReplaceListTable } from 'src/sections/dashboard/company/request-replace-list-table';
const Page = () => {
      ...
      >
        <Container maxWidth="xl">
          ...
          <Stack spacing={4}>
            ...
            >
              <Stack spacing={1}>
                <Typography variant="h4">Orders to replace</Typography>
              </Stack>
            </Stack>
            <Card>
              <RequestReplaceListTable requests={requests} />
            </Card>
          </Stack>
        </Container>
      </Box>
