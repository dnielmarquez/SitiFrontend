...
import { SupplierCompletedOrderListTable } from 'src/sections/dashboard/supplier/supplier-completed-orders-list-table';
const Page = () => {
      ...
      >
        <Container maxWidth="xl">
          ...
          <Stack spacing={4}>
            ...
            <Card>
              <SupplierCompletedOrderListTable orders={orders} />
            </Card>
          </Stack>
        </Container>
      </Box>
