...
import { SupplierReplaceOrderListTable } from 'src/sections/dashboard/supplier/supplier-replace-orders-list-table';
const Page = () => {
      ...
      >
        <Container maxWidth="xl">
          ...
          <Stack spacing={4}>
            ...
            <Card>
              <SupplierReplaceOrderListTable orders={orders} />
            </Card>
          </Stack>
        </Container>
      </Box>
