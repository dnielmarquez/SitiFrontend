...
export const RequestCompletedListTable = (props: { requests: Request[] | [] }) => {
    ...
    <Box sx={{ position: 'relative' }}>
      <Scrollbar>
        <Table sx={{ minWidth: 700 }}>
          ...
          <TableBody>
            {props.requests
              .filter((request) => request.status === 'Accepted' || request.status === 'AcceptAsIs') // Filtrado basado en el estado
              .map((request) => (
                <TableRow
                  hover
                  key={request.id}
                >
                  ...
                  <TableCell align="right">
                    <Stack
                      ...
                      spacing={1}
                    >
                      {(request.status == 'Accepted' || request.status == 'AcceptAsIs') && (
                        <>
                          <Button
                            onClick={() =>
